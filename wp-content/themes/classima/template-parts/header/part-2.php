...
<div class="main-header-inner">
    <div class="site-branding">
        ...
        <?php if (!empty($dark_logo['url'])): ?>
            <a class="dark-logo" href="<?php echo esc_url( home_url( '/' ) );?>"><img src="<?php echo esc_url( $dark_logo['url'] ); ?>" width="<?php echo esc_attr( $dark_logo['width'] );?>" height="<?php echo esc_attr( $dark_logo['height'] );?>"  alt="<?php esc_attr( bloginfo( 'name' ) ) ;?>"></a>
        <?php else: ?>
        ...
        <?php if (!empty($light_logo['url'])): ?>
            <a class="light-logo" href="<?php echo esc_url( home_url( '/' ) );?>"><img src="<?php echo esc_url( $light_logo['url'] ); ?>" height="<?php echo esc_attr( $light_logo['height'] );?>" width="<?php echo esc_attr( $light_logo['width'] );?>" alt="<?php esc_attr( bloginfo( 'name' ) ) ;?>"></a>
        <?php else: ?>
