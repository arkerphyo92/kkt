                ...
                <?php if ( $store->is_rating_enable() ): ?>
                    <li class="store-rating"><i class="fa fa-trophy" aria-hidden="true"></i>
                        <?php if ( $store->get_review_counts() ): ?>
                            <?php echo Fns::get_rating_html( $store->get_average_rating(), $store->get_review_counts() ); ?><span class="reviews-rating-count">(<?php echo absint( $store->get_review_counts() ); ?>)</span>
                        <?php else: ?>
