...
class Listing_Functions {
	...
	public function __construct() {
		...
		add_action( 'classima_listing_list_view_after_content', array(
			$this,
		...
		add_filter( 'classima_single_listing_time_format', array(
			$this,
		...
		// Profile page
		remove_action( 'rtcl_edit_account_form', array(
