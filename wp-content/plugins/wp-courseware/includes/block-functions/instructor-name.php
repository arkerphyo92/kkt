...
/**
 * Certificate Instructor Name block render callback function.
 *
 * @since 4.8.0
 * 
 ...
 * @return string
 */
function wpcw_certificate_instructor_name_render_callback( $attributes ) {
	...
	$instructor_title = isset( $attributes['instructorTitle'] ) ? $attributes['instructorTitle'] : '';
	...
	?>
	<div class="wpcw-certificate-instructor_name" style="<?php echo esc_attr( $style ); ?>">
		INSTRUCTOR NAME <br/>
		<?php echo esc_html( $instructor_title ); ?>
	</div>
	<?php
	$html = ob_get_clean();
